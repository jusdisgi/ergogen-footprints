...
//
// KiCad 8 update by @huntercooh https://github.com/jusdisgi/ergogen-footprints
// Nothing changed but the arc definitions from the original footprint included in the main ergogen repo.
//
//   __________________
//  (f) (t)         | |
//  | (1)           | |
    ...
    body: p => {
      ...
      function pins(def_neg, def_pos) {
        return `
          ...
          ${'' /* arcs changed to kicad8 2025-06-07 */}
          (fp_arc (start ${def_pos}9.8 7.3)	(mid ${def_pos}9.712133 7.512132)	(end ${def_pos}9.5 7.6) (layer Edge.Cuts) (width 0.15))
      		(fp_arc (start ${def_pos}7.7 7.6)	(mid ${def_pos}7.487868 7.512132)	(end ${def_pos}7.4 7.3) (layer Edge.Cuts) (width 0.15))
			    (fp_arc (start ${def_pos}9.5 -6.6) (mid ${def_pos}9.712132 -6.512132) (end ${def_pos}9.8 -6.3) (layer Edge.Cuts) (width 0.15))
			    (fp_arc (start ${def_pos}7.4 -6.3) (mid ${def_pos}7.487868 -6.512132)	(end ${def_pos}7.7 -6.6) (layer Edge.Cuts) (width 0.15))
